...
/**
 * NomadesWP2018 functions and definitions
 *
...
if ( ! function_exists( 'ng_wp_starter_setup' ) ) :
	...
	function ng_wp_starter_setup() {
		 ...
		 * If you're building a theme based on NomadesWP2018, use a find and replace
		 * to change 'nomades-wp-2018' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'nomades-wp-2018', get_template_directory() . '/languages' );
		...
		// 	'menu-1' => esc_html__( 'Primary', 'nomades-wp-2018' ),
		// ) );
		register_nav_menus( array(
...
// 		'name'          => esc_html__( 'Sidebar', 'nomades-wp-2018' ),
// 		'id'            => 'sidebar-1',
// 		'description'   => esc_html__( 'Add widgets here.', 'nomades-wp-2018' ),
...
function ng_wp_starter_scripts() {
	...
	wp_enqueue_style( 'nomades-wp-2018-style', get_stylesheet_uri() );
	wp_enqueue_script( 'nomades-wp-2018-runtime', get_template_directory_uri() . '/js/runtime.js', array(), '',true );
	wp_enqueue_script( 'nomades-wp-2018-polyfills', get_template_directory_uri() . '/js/polyfills.js', array(), '',true );
	wp_enqueue_script( 'nomades-wp-2018-main', get_template_directory_uri() . '/js/main.js', array(), '', true );
